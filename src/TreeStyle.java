...
public class TreeStyle extends Style {
    ...
    public void draw(Node root, Component IconFamily){
        ArrayList<Boolean> boolArray = new ArrayList<>();
        printTree(root, 0, IconFamily, boolArray);
    }
    private void printTree(Node node, int level, Component iconFamily, ArrayList<Boolean> boolArray) {
